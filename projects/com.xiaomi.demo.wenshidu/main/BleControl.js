...
export default class BleControl extends React.Component {
  ...
  sendTestText() {
    ...
    if (this.state.scType === 0) {
      ...
      bt.securityLock.encryptMessageWithToken(text).then((res) => {
        ...
        this.addLog(`encrypted message is：${ result }`)
      })
        .catch((err) => {
      ...
      bt.securityLock.encryptMessage(text)
        .then((hex) => {
          this.addLog(`encrypted message is：${ hex }`);
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={{ flex: 1 }}>
          <CardButton
            ...
            icon={require('../resources/images/icon_ble.png')}
            onPress={() => {
          ...
          <CardButton
            ...
            icon={require('../resources/images/icon_notify.png')}
            onPress={() => {
          ...
          <CardButton
            ...
            icon={require('../resources/images/icon_write.png')}
            onPress={() => {
              this.sendTestText();
            }}
          />
          <CardButton
            ...
            icon={require('../resources/images/icon_normal_dfu.png')}
            onPress={() => {
