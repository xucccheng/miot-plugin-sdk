      ...
      <View style={styles.container}>
        ...
        >
          ...
          {/* <View style={{ backgroundColor: '#ffffff', height: 32, justifyContent: 'center', paddingLeft: SdkStyles.common.padding }}>
            <Text style={{ fontSize: 11, color: 'rgba(0,0,0,0.5)', lineHeight: 14 }}>{PluginStrings.baseInfo}</Text>
          </View> */}
          ...
          {/* <ListItem
            title={PluginStrings.deviceInfo}
            onPress={() => {
              this.props.navigation.navigate('DevicePage', { title: PluginStrings.deviceInfo });
            }}
          /> */}
